...
#About----
#Project:Delta Smelt Sample Processing  flow chart visualization 
#Purpose: Illustrate the processing of Delta Smelt samples by the surveys
...
#Import Data ----
samflow <- read_csv(file.path(data_root,"SampleProcessing.csv"))
...
samflow$pathString <- paste(samflow$Delivery,samflow$Preservation, samflow$Laboratory, samflow$Action, samflow$Dissection,
                            samflow$Collection, samflow$Transfer,samflow$Evaluate, sep = "/")
